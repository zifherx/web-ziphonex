...
import { TESTIMONIAL_FILTROS_PROPS } from "@/common/types/testimonial.props";

export function TestimonialFilters({
  authorNameFilter,
  onAuthorNameFilterChange,
  onStatusFilterChange,
  setView,
  statusFilter,
  view,
}: TESTIMONIAL_FILTROS_PROPS) {
  return (
      ...
      <div className="relative flex">
        <InputGroup className="h-12 w-md border-gray-300 rounded-lg focus:outline-none focus:ring-2 has-[[data-slot=input-group-control]:focus-visible]:ring-secondary focus:border-transparent">
          <InputGroupInput
            ...
            onChange={(e) => onAuthorNameFilterChange(e.target.value)}
            disabled={view === "card"}
          />
          <InputGroupAddon>
