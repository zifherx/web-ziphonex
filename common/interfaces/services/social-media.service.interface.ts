...
export interface ISocialMediaService {
  ...
  update(id: string, data: UpdateSocialMediaDto): Promise<SocialMediaResponseDto>;
  ...
  updateStatus(id: string, status: STATUS_TYPE_ENTRY_CMS): Promise<SocialMediaResponseDto>;
