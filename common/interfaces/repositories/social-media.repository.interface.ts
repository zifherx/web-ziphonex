...
import { SocialMediaEntity, SocialMediaFilters, STATUS_TYPE_ENTRY_CMS } from "@/common/types/social-media.types";

export interface ISocialMediaRepository
  extends IBaseRepository<SocialMediaEntity, CreateSocialMediaDto, UpdateSocialMediaDto> {
  ...
  update(id: string, data: UpdateSocialMediaDto): Promise<SocialMediaEntity | null>;
  ...
  updateStatus(id: string, status: STATUS_TYPE_ENTRY_CMS): Promise<SocialMediaEntity | null>;
}
